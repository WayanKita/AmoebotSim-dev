...
#ifndef AMOEBOTSIM_ALG_TEST_H_
#define AMOEBOTSIM_ALG_TEST_H_
...
class TestParticle : public AmoebotParticle {
 public:
  ...
  TestParticle(const Node head, const int globalTailDir,
  ...
  TestParticle& nbrAtLabel(int label) const;
...
class TestSystem : public AmoebotSystem {
 public:
  // Constructs a system of two TestParticles (one leader and one follower).
  TestSystem();
